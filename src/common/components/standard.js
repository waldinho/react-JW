      	...
      	<div className="posts">
              ...
              <div className="center"><Link to="/portfolio" className="more"><span className="larger-arrow">&gt;</span>Back</Link></div>
                <div className="main-content pad-50">
                  ...
                  <p>The templates were built using ejs templates, this allowed us to parse the data in using a json feed. The whole site worked on the MVC framework structuring principle and as you can see from the before and after shots of the homepage below I think it turned out very well.
                  </p>
                  <div className="tabs">
                    <Link to="/portfolio/evening-standard" className="tab active-tab">Before</Link>
								    <Link to="/portfolio/evening-standard-after" className="tab">After</Link>
                  </div>
                </div>
              </div>
          </div>
